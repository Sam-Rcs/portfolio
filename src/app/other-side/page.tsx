      ...
      <section id="exit-3d" className="relative py-28 px-6 bg-[#0a0b10] border-t border-white/10 text-center">
        ...
        <div className="max-w-2xl mx-auto relative z-10 p-8 sm:p-12 rounded-3xl bg-black/60 border border-white/10 shadow-2xl space-y-5">
          ...
          <p className="text-sm font-mono text-neutral-400 max-w-md mx-auto leading-relaxed">
            Ready to head back to the clean, polite 2D world where CSS is stable and nobody is scrubbing 192 frames?
          </p>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full font-mono text-xs text-rose-300 border border-rose-500/30 bg-rose-500/10 hover:bg-rose-500/20 transition-all hover:scale-105"
            >
              <ShieldAlert className="w-3.5 h-3.5" />
              <span>Emergency Escape (Esc)</span>
            </Link>
          </div>
        </div>
      </section>
